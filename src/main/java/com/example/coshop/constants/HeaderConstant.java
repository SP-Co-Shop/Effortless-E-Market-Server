...
public class HeaderConstants {
    ...
    public static final String KEY_REQUEST_LOGGER_DO_WRITE_LOG = "KEY_REQUEST_LOGGER_DO_WRITE_LOG";

    public static final String KEY_REQUEST_LOGGER_CLIENT_IP = "KEY_REQUEST_LOGGER_CLIENT_IP";
    public static final String KEY_REQUEST_LOGGER_ELAPSED_MILLI = "KEY_REQUEST_LOGGER_ELAPSED_MILLI";
}
